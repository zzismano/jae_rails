...
/** @type {Record<DismissReason, DismissReason>} */const g=Object.freeze({cancel:"cancel",backdrop:"backdrop",close:"close",esc:"esc",timer:"timer"});
/**
...
/**
   ...
   */const setFocus=(e,t)=>{var o;const n=getFocusableElements();if(n.length){e+=t;e===n.length?e=0:e===-1&&(e=n.length-1);n[e].focus()}else(o=getPopup())===null||o===void 0||o.focus()};const b=["ArrowRight","ArrowDown"];const v=["ArrowLeft","ArrowUp"];
/**
   * @param {SweetAlertOptions} innerParams
   * @param {KeyboardEvent} event
   * @param {Function} dismissWith
   */const keydownHandler=(e,t,o)=>{if(e&&!t.isComposing&&t.keyCode!==229){e.stopKeydownPropagation&&t.stopPropagation();t.key==="Enter"?handleEnter(t,e):t.key==="Tab"?handleTab(t):[...b,...v].includes(t.key)?handleArrows(t.key):t.key==="Escape"&&handleEsc(t,e,o)}};
/**
   * @param {KeyboardEvent} event
   * @param {SweetAlertOptions} innerParams
...
/** @type HTMLElement[] */const a=[o,n,s];if(document.activeElement instanceof HTMLElement&&!a.includes(document.activeElement))return;const i=b.includes(e)?"nextElementSibling":"previousElementSibling";let r=document.activeElement;if(r){for(let e=0;e<t.children.length;e++){r=r[i];if(!r)return;if(r instanceof HTMLButtonElement&&isVisible$1(r))break}r instanceof HTMLButtonElement&&r.focus()}};
/**
   * @param {KeyboardEvent} event
   * @param {SweetAlertOptions} innerParams
   * @param {Function} dismissWith
   */const handleEsc=(e,t,o)=>{if(callIfFunction(t.allowEscapeKey)){e.preventDefault();o(g.esc)}};var y={swalPromiseResolve:new WeakMap,swalPromiseReject:new WeakMap};const setAriaHidden=()=>{const e=getContainer();const t=Array.from(document.body.children);t.forEach((t=>{if(!t.contains(e)){t.hasAttribute("aria-hidden")&&t.setAttribute("data-previous-aria-hidden",t.getAttribute("aria-hidden")||"");t.setAttribute("aria-hidden","true")}}))};const unsetAriaHidden=()=>{const e=Array.from(document.body.children);e.forEach((e=>{if(e.hasAttribute("data-previous-aria-hidden")){e.setAttribute("aria-hidden",e.getAttribute("data-previous-aria-hidden")||"");e.removeAttribute("data-previous-aria-hidden")}else e.removeAttribute("aria-hidden")}))};const x=typeof window!=="undefined"&&!!window.GestureEvent;const iOSfix=()=>{if(x&&!hasClass(document.body,a.iosfix)){const e=document.body.scrollTop;document.body.style.top=e*-1+"px";addClass(document.body,a.iosfix);lockBodyScroll()}};const lockBodyScroll=()=>{const e=getContainer();if(!e)return;
/** @type {boolean} */let t;
/**
...
/**
   ...
   */const replaceScrollbarWithPadding=e=>{if(k===null&&(document.body.scrollHeight>window.innerHeight||e==="scroll")){k=parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"));document.body.style.paddingRight=`${k+measureScrollbar()}px`}};const undoReplaceScrollbarWithPadding=()=>{if(k!==null){document.body.style.paddingRight=`${k}px`;k=null}};
/**
   * @param {SweetAlert} instance
   * @param {HTMLElement} container
   * @param {boolean} returnFocus
   * @param {Function} didClose
   */function removePopupAndResetState(e,t,n,s){if(isToast())triggerDidCloseAndDispose(e,s);else{restoreActiveElement(n).then((()=>triggerDidCloseAndDispose(e,s)));removeKeydownHandler(o)}if(x){t.setAttribute("style","display:none !important");t.removeAttribute("class");t.innerHTML=""}else t.remove();if(isModal()){undoReplaceScrollbarWithPadding();undoIOSfix();unsetAriaHidden()}removeBodyClasses()}function removeBodyClasses(){removeClass([document.documentElement,document.body],[a.shown,a["height-auto"],a["no-backdrop"],a["toast-shown"]])}
/**
   * Instance method to close sweetAlert
   *
   * @param {any} resolveValue
   */function close(t){t=prepareResolveValue(t);const o=y.swalPromiseResolve.get(this||e);const n=triggerClosePopup(this||e);if((this||e).isAwaitingPromise){if(!t.isDismissed){handleAwaitingPromise(this||e);o(t)}}else n&&o(t)}const triggerClosePopup=e=>{const t=getPopup();if(!t)return false;const o=w.innerParams.get(e);if(!o||hasClass(t,o.hideClass.popup))return false;removeClass(t,o.showClass.popup);addClass(t,o.hideClass.popup);const n=getContainer();removeClass(n,o.showClass.backdrop);addClass(n,o.hideClass.backdrop);handlePopupAnimation(e,t,o);return true};
/**
   * @param {any} error
   */function rejectPromise(t){const o=y.swalPromiseReject.get(this||e);handleAwaitingPromise(this||e);o&&o(t)}
/**
   * @param {SweetAlert} instance
...
/**
   ...
   */const showLoading=e=>{let t=getPopup();t||new z;t=getPopup();if(!t)return;const o=getLoader();isToast()?hide(getIcon()):replaceButton(t,e);show(o);t.setAttribute("data-loading","true");t.setAttribute("aria-busy","true");t.focus()};
/**
   * @param {HTMLElement} popup
   * @param {HTMLButtonElement | null} [buttonToReplace]
...
/**
   * @param {SweetAlert} instance
   * @param {Function} dismissWith
   */const handleCancelButtonClick=(e,t)=>{e.disableButtons();t(g.cancel)};
/**
   * @param {SweetAlert} instance
...
/**
   * @param {SweetAlert} instance
   */const disposeWeakMaps=e=>{if(e.isAwaitingPromise){unsetWeakMaps(w,e);e.isAwaitingPromise=true}else{unsetWeakMaps(y,e);unsetWeakMaps(w,e);delete e.isAwaitingPromise;delete e.disableButtons;delete e.enableButtons;delete e.getInput;delete e.disableInput;delete e.enableInput;delete e.hideLoading;delete e.disableLoading;delete e.showValidationMessage;delete e.resetValidationMessage;delete e.close;delete e.closePopup;delete e.closeModal;delete e.closeToast;delete e.rejectPromise;delete e.update;delete e._destroy}};
/**
   * @param {object} obj
   * @param {SweetAlert} instance
   */const unsetWeakMaps=(e,t)=>{for(const o in e)e[o].delete(t)};var P=Object.freeze({__proto__:null,_destroy:_destroy,close:close,closeModal:close,closePopup:close,closeToast:close,disableButtons:disableButtons,disableInput:disableInput,disableLoading:hideLoading,enableButtons:enableButtons,enableInput:enableInput,getInput:getInput,handleAwaitingPromise:handleAwaitingPromise,hideLoading:hideLoading,rejectPromise:rejectPromise,resetValidationMessage:resetValidationMessage,showValidationMessage:showValidationMessage,update:update});
/**
   * @param {SweetAlertOptions} innerParams
...
/**
   ...
   * @param {DomCache} domCache
   * @param {Function} dismissWith
   */const handleToastClick=(e,t,o)=>{t.popup.onclick=()=>{e&&(isAnyButtonShown(e)||e.timer||e.input)||o(g.close)}};
/**
   * @param {SweetAlertOptions} innerParams
   * @returns {boolean}
   */const isAnyButtonShown=e=>!!(e.showConfirmButton||e.showDenyButton||e.showCancelButton||e.showCloseButton);let $=false;
/**
   * @param {DomCache} domCache
   */const handleModalMousedown=e=>{e.popup.onmousedown=()=>{e.container.onmouseup=function(t){e.container.onmouseup=()=>{};t.target===e.container&&($=true)}}};
/**
   * @param {DomCache} domCache
   */const handleContainerMousedown=e=>{e.container.onmousedown=t=>{t.target===e.container&&t.preventDefault();e.popup.onmouseup=function(t){e.popup.onmouseup=()=>{};(t.target===e.popup||t.target instanceof HTMLElement&&e.popup.contains(t.target))&&($=true)}}};
/**
   * @param {SweetAlertOptions} innerParams
   * @param {DomCache} domCache
   * @param {Function} dismissWith
   */const handleModalClick=(e,t,o)=>{t.container.onclick=n=>{$?$=false:n.target===t.container&&callIfFunction(e.allowOutsideClick)&&o(g.backdrop)}};const isJqueryElement=e=>typeof e==="object"&&e.jquery;const isElement=e=>e instanceof Element||isJqueryElement(e);const argsToParams=e=>{const t={};typeof e[0]!=="object"||isElement(e[0])?["title","html","icon"].forEach(((o,n)=>{const s=e[n];typeof s==="string"||isElement(s)?t[o]=s:s!==void 0&&error(`Unexpected type of ${o}! Expected "string" or "Element", got ${typeof s}`)})):Object.assign(t,e[0]);return t};
/**
...
/**
   ...
   *
   * @returns {boolean}
   */const isTimerRunning=()=>!!(o.timeout&&o.timeout.isRunning());let S=false;const L={};
/**
   * @param {string} attr
   */function bindClickHandler(){let t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"data-swal-template";L[t]=this||e;if(!S){document.body.addEventListener("click",bodyClickListener);S=true}}const bodyClickListener=e=>{for(let t=e.target;t&&t!==document;t=t.parentNode)for(const e in L){const o=t.getAttribute(e);if(o){L[e].fire({template:o});return}}};class EventEmitter{constructor(){
/** @type {Events} */
this.events={}}
/**
...
/**
     * @returns {boolean}
     */isRunning(){return this.running}}const O=["swal-title","swal-html","swal-footer"];
/**
   * @param {SweetAlertOptions} params
   * @returns {SweetAlertOptions}
...
/** @type {DocumentFragment} */const o=t.content;showWarningsForElements(o);const n=Object.assign(getSwalParams(o),getSwalFunctionParams(o),getSwalButtons(o),getSwalImage(o),getSwalIcon(o),getSwalInput(o),getSwalStringParams(o,O));return n};
/**
...
const t={};
/** @type {HTMLElement[]} */const o=Array.from(e.querySelectorAll("swal-param"));o.forEach((e=>{showWarningsForAttributes(e,["name","value"]);const o=/** @type {keyof SweetAlertOptions} */e.getAttribute("name");const n=e.getAttribute("value");o&&n&&(typeof C[o]==="boolean"?t[o]=n!=="false":typeof C[o]==="object"?t[o]=JSON.parse(n):t[o]=n)}));return t};
/**
   * @param {DocumentFragment} templateContent
   * @returns {Record<string, any>}
...
/**
   * @param {DocumentFragment} templateContent
   */const showWarningsForElements=e=>{const t=O.concat(["swal-param","swal-function-param","swal-button","swal-image","swal-icon","swal-input","swal-input-option"]);Array.from(e.children).forEach((e=>{const o=e.tagName.toLowerCase();t.includes(o)||warn(`Unrecognized element <${o}>`)}))};
/**
   * @param {HTMLElement} el
   * @param {string[]} allowedAttributes
   */const showWarningsForAttributes=(e,t)=>{Array.from(e.attributes).forEach((o=>{t.indexOf(o.name)===-1&&warn([`Unrecognized attribute "${o.name}" on <${e.tagName.toLowerCase()}>.`,""+(t.length?`Allowed attributes are: ${t.join(", ")}`:"To set the value, use HTML within the element.")])}))};const M=10;
/**
   * Open popup, add necessary classes and styles, fix scrollbar
   *
   * @param {SweetAlertOptions} params
   */const openPopup=e=>{const t=getContainer();const n=getPopup();typeof e.willOpen==="function"&&e.willOpen(n);o.eventEmitter.emit("willOpen",n);const s=window.getComputedStyle(document.body);const i=s.overflowY;addClasses(t,n,e);setTimeout((()=>{setScrollingVisibility(t,n)}),M);if(isModal()){fixScrollContainer(t,e.scrollbarPadding,i);setAriaHidden()}isToast()||o.previousActiveElement||(o.previousActiveElement=document.activeElement);typeof e.didOpen==="function"&&setTimeout((()=>e.didOpen(n)));o.eventEmitter.emit("didOpen",n);removeClass(t,a["no-transition"])};
/**
...
/**
   * @param {SweetAlertOptions} params
   */function setDefaultInputValidators(e){if(!e.inputValidator){e.input==="email"&&(e.inputValidator=j.email);e.input==="url"&&(e.inputValidator=j.url)}}
/**
   * @param {SweetAlertOptions} params
...
/** @type {SweetAlert} */let I;var H=new WeakMap;class SweetAlert{
/**
     * @param {...any} args
     * @this {SweetAlert}
     */
...
/**
       ...
       */
_classPrivateFieldInitSpec(this,H,void 0);if(typeof window==="undefined")return;I=this;for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];const n=Object.freeze(this.constructor.argsToParams(t));
/** @type {Readonly<SweetAlertOptions>} */this.params=n;
/** @type {boolean} */this.isAwaitingPromise=false;_classPrivateFieldSet2(H,this,this._main(I.params))}_main(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};showWarningsForParams(Object.assign({},t,e));if(o.currentInstance){const e=y.swalPromiseResolve.get(o.currentInstance);const{isAwaitingPromise:t}=o.currentInstance;o.currentInstance._destroy();t||e({isDismissed:true});isModal()&&unsetAriaHidden()}o.currentInstance=I;const n=prepareParams(e,t);setParameters(n);Object.freeze(n);if(o.timeout){o.timeout.stop();delete o.timeout}clearTimeout(o.restoreFocusTimeout);const s=populateDomCache(I);render(I,n);w.innerParams.set(I,n);return swalPromise(I,s,n)}then(e){return _classPrivateFieldGet2(H,this).then(e)}finally(e){return _classPrivateFieldGet2(H,this).finally(e)}}
/**
   * @param {SweetAlert} instance
   * @param {DomCache} domCache
   * @param {SweetAlertOptions} innerParams
...
/**
       ...
       */
const dismissWith=t=>{e.close({isDismissed:true,dismiss:t})};y.swalPromiseResolve.set(e,s);y.swalPromiseReject.set(e,a);t.confirmButton.onclick=()=>{handleConfirmButtonClick(e)};t.denyButton.onclick=()=>{handleDenyButtonClick(e)};t.cancelButton.onclick=()=>{handleCancelButtonClick(e,dismissWith)};t.closeButton.onclick=()=>{dismissWith(g.close)};handlePopupClick(n,t,dismissWith);addKeydownHandler(o,n,dismissWith);handleInputOptionsAndValue(e,n);openPopup(n);setupTimer(o,n,dismissWith);initFocus(t,n);setTimeout((()=>{t.container.scrollTop=0}))}));
/**
   * @param {SweetAlertOptions} userParams
   * @param {SweetAlertOptions} mixinParams
   * @returns {SweetAlertOptions}
   */const prepareParams=(e,t)=>{const o=getTemplateParams(e);const n=Object.assign({},C,t,o,e);n.showClass=Object.assign({},C.showClass,n.showClass);n.hideClass=Object.assign({},C.hideClass,n.hideClass);if(n.animation===false){n.showClass={backdrop:"swal2-noanimation"};n.hideClass={}}return n};
/**
   * @param {SweetAlert} instance
   * @returns {DomCache}
