class LeisuresController < ApplicationController
  ...
  def leisure_params
    params.require(:leisure).permit(:category_id, :subcategory_id, :photo, :link, :title, :subtitle, :director, :country, :description, :schedule, :features, :min_age, :duration, :time, :start_date, :end_date, :publish_date, :hidden, :free, :date, :alt_text, dates: [])
  end
